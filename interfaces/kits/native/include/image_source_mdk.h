...
/**
 * @brief Defines a native OhosImageRegion alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageRegion Image_Region;
...
/**
 * @brief Defines a native OhosImageSourceOps alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceOps ImageSource_Options;
...
/**
 * @brief Defines a native OhosImageDecodingOps alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageDecodingOps Image_DecodingOptions;
...
/**
 * @brief Defines a native OhosImageSourceInfo alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceInfo ImageSource_Info;
...
/**
 * @brief Defines a native OhosImageSource alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSource ImageSource_Source;
...
/**
 * @brief Defines a native OhosImageSourceDelayTimeList alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceDelayTimeList ImageSource_DelayTimeList;
...
/**
 * @brief Defines a native OhosImageSourceSupportedFormat alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceSupportedFormat ImageSource_SupportedFormat;
...
/**
 * @brief Defines a native OhosImageSourceSupportedFormatList alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceSupportedFormatList ImageSource_SupportedFormatList;
...
/**
 * @brief Defines a native OhosImageSourceProperty alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceProperty ImageSource_Property;
...
/**
 * @brief Defines a native OhosImageSourceUpdateData alias for the image source Capi.
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
typedef struct OhosImageSourceUpdateData ImageSource_UpdateData;
...
/** ImageSource Capi */
enum ImageResourceType_ : int32_t {
...
struct ImageResource_ {
    ImageResourceType_ type = ImageResourceType_::IMAGE_RESOURCE_INVAILD;
    int32_t fd = -1;
    std::string path;
    uint8_t* buffer = nullptr;
    size_t bufferSize = 0;
...
typedef struct ImageResource_ Image_Resource;
/**
 * @brief Creates an void pointer(from ImageSource pointer convert) at the C++ native layer based on the specified
 * image source URI and {@link OhosImageSourceOps} structs.
 *
 * @param uri Indicates a pointer to the image source URI. Only a file URI or Base64 URI is accepted.
 * @param size Indicates the length of the image source URI.
 ...
 * @version 4.1
 */
int32_t OH_ImageSourceCapi_CreateFromUri( char* uri, size_t size,
    ImageSource_Options* ops, void* res);

/**
 * @brief Creates an void pointer(from ImageSource pointer convert) at the native C++ layer based on the specified
 * image source file descriptor and {@link OhosImageSourceOps} structs.
 *
 * @param fd Indicates the image source file descriptor.
 * @param ops Indicates a pointer to the options for creating the image source.
 ...
 * @version 4.1
 */
int32_t OH_ImageSourceCapi_CreateFromFd(int32_t fd, ImageSource_Options* ops,
    void *res);
 ...
 * @version 4.1
 */ 
int32_t OH_ImageSourceCapi_CreateFromRawFile(RawFileDescriptor rawFile, 
    ImageSource_Options* ops, void *res);

/**
 * @brief Creates an void pointer(from incremental ImageSource pointer convert)  at the C++ native 
 * layer based on the specified
 * {@link OhosImageSource} and {@link OhosImageSourceOps} structs.
 * The image source data will be updated through {@link OH_ImageSource_UpdateData}.
 *
 * @param src Indicates a pointer to the input resource of the image source. Only the buffer type is accepted.
 ...
 * @useinstead image#OH_ImageSource_CreateIncrementalFromData
 */
int32_t OH_ImageSourceCapi_CreateIncremental(ImageSource_Source* source, 
    ImageSource_Options* ops, void* res);

/**
 * @brief Updates the data of an <b>ImageSource</b> object.
 *
 * @param imgSrc Indicates a void pointer(from ImageSource pointer convert).
 * @param decOption Indicates a pointer to the options for decoding the image source.
 * For details, see {@link OhosImageDecodingOps}.
 * @param data Indicates a pointer to the update data. For details, see {@link OhosImageSourceUpdateData}.
 * @return Returns {@link IRNdkErrCode} IMAGE_RESULT_SUCCESS - if the operation is successful.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_BAD_PARAMETER - if bad parameter.
 ...
 * returns {@link IRNdkErrCode} IMAGE_RESULT_ALPHA_TYPE_ERROR - if hard decode failed.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_ALLOCATER_TYPE_ERROR - if hard decode failed.
 * @see {@link ImageSource}, {@link OhosImageSourceUpdateData}
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */     
int32_t OH_ImageSourceCapi_UpdateData(void* imgSrc, 
    Image_DecodingOptions* decOption, ImageSource_UpdateData* data);

/**
 * @brief Decodes an void pointer(from ImageSource pointer convert) to obtain a <b>PixelMap</b> 
 * object at the C++ native layer
 * based on the specified {@link OhosImageDecodingOps} struct.
 *
 * @param imgSrc Indicates a void pointer(from ImageSource pointer convert).
 * @param ops Indicates a pointer to the options for decoding the image source.
 ...
 * returns {@link IRNdkErrCode} IMAGE_RESULT_ALPHA_TYPE_ERROR - if hard decode failed.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_ALLOCATER_TYPE_ERROR - if hard decode failed.
 * @see {@link ImageSource}, {@link OhosImageDecodingOps}
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
...
int32_t OH_ImageSourceCapi_CreatePixelMap(void* imgSrc, Image_DecodingOptions* ops, void* resPixMap);

/**
 * @brief Decodes an void pointer(from ImageSource pointer convert) to obtain all 
 ...
 * @version 4.0
 */
int32_t OH_ImageSourceCapi_CreatePixelMapList(void* imgSrc,
    Image_DecodingOptions* ops, void* resVecPixMap[], uint32_t* outSize);
 ...
 * returns {@link IRNdkErrCode} IMAGE_RESULT_DECODE_EXIF_UNSUPPORT - if image decode exif unsupport.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_PROPERTY_NOT_EXIST - if image property not exist.
 * @see {@link ImageSource}, {@link OhosImageSourceDelayTimeList}
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
int32_t OH_ImageSourceCapi_GetDelayTime(void* imgSrc,
    ImageSource_DelayTimeList* res);
 ...
 * returns {@link IRNdkErrCode} IMAGE_RESULT_DECODE_EXIF_UNSUPPORT - if image decode exif unsupport.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_PROPERTY_NOT_EXIST - if image property not exist.
 * @see {@link ImageSource}, {@link OhosImageSourceInfo}
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 */
int32_t OH_ImageSourceCapi_GetImageInfo(void* imgSrc, int32_t index,
    ImageSource_Info* info);
 ...
 * returns {@link IRNdkErrCode} IMAGE_RESULT_DECODE_EXIF_UNSUPPORT - if image decode exif unsupport.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_PROPERTY_NOT_EXIST - if image property not exist.
 * @see {@link ImageSource}, {@link OhosImageSourceProperty}
 *
 * @Syscap SystemCapability.Multimedia.Image
 * @since 10
 * @version 4.0
 ...
 * @brief Modifies the value of an image property of an <b>ImageSource</b> object.
 * @param imgSrc Indicates a void pointer(from ImageSource pointer convert).
 * @param imgResource Indicates a pointer to the imageResource, see {@link ImageResource} .
 * @param key Indicates a pointer to the property. For details, see {@link OhosImageSourceProperty}.
 * @param value Indicates a pointer to the new value of the property.
 * @return Returns {@link IRNdkErrCode} IMAGE_RESULT_SUCCESS - if the operation is successful.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_BAD_PARAMETER - if bad parameter.
 ...
 * @brief Obtains the number of frames from an <b>ImageSource</b> object.
 *
 * @param imgSrc Indicates a pointer to the {@link ImageSourc} object at the C++ native layer.
 * @param res Indicates a pointer to the number of frames obtained.
 * @return Returns {@link IRNdkErrCode} IMAGE_RESULT_SUCCESS - if the operation is successful.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_BAD_PARAMETER - if bad parameter.
 * returns {@link IRNdkErrCode} IMAGE_RESULT_INVALID_PARAMETER - if invalid parameter.
