...
#ifndef INTERFACES_INNERKITS_INCLUDE_IMAGE_MIME_TYPE_H_
#define INTERFACES_INNERKITS_INCLUDE_IMAGE_MIME_TYPE_H_
...
static const std::string IMAGE_ICO_FORMAT = "image/ico";

} // namespace Media
} // namespace OHOS

#endif // INTERFACES_INNERKITS_INCLUDE_IMAGE_MIME_TYPE_H_