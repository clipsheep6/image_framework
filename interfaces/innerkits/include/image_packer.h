...
public:
    ...
    uint32_t StartPacking(const std::string &filePath, const PackOption &option, bool autoFileClose = true);
    uint32_t StartPacking(const int &fd, const PackOption &option, bool autoFileClose = true);
