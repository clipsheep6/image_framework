...
const uint32_t ERR_IMAGE_UNSUPPORTED_MIME_TYPE = BASE_MEDIA_ERR_OFFSET + 183; // image mime type unsupported
const uint32_t ERR_IMAGE_UNKNOWN_MIME_TYPE = BASE_MEDIA_ERR_OFFSET + 184; // image mime type unknown
const uint32_t ERR_IMAGE_INVALID_SOURCE_DATA = BASE_MEDIA_ERR_OFFSET + 185; // image data source parse failed
const uint32_t ERR_IMAGE_SOURCE_IS_NULL = BASE_MEDIA_ERR_OFFSET + 186; // parse image source failed
const uint32_t ERR_IMAGE_PIXELMAP_IS_NULL = BASE_MEDIA_ERR_OFFSET + 187; // parse pixelmap failed
const uint32_t ERR_IMAGE_GET_DATA_FAILED = BASE_MEDIA_ERR_OFFSET + 188; // get image data failed
const uint32_t ERR_IMAGE_UNKNOWN_ERROR = BASE_MEDIA_ERR_OFFSET + 189; // image unknown error
