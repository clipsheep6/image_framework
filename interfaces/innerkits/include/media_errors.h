...
const uint32_t ERR_OPEN_EXIV2_IMAGE_PATH = BASE_MEDIA_ERR_OFFSET + 300;
const uint32_t ERR_OPEN_EXIV2_IMAGE_BUF = BASE_MEDIA_ERR_OFFSET + 301;
const uint32_t ERR_OPEN_EXIV2_IMAGE_FD = BASE_MEDIA_ERR_OFFSET + 302;
const uint32_t ERR_OPEN_EXIV2_IMAGE_FD_MALLOC = BASE_MEDIA_ERR_OFFSET + 303;
const uint32_t ERR_OPEN_EXIV2_IMAGE_FD_READ = BASE_MEDIA_ERR_OFFSET + 304;
const uint32_t ERR_OPEN_EXIV2_IMAGE_FD_OPEN = BASE_MEDIA_ERR_OFFSET + 305;
const uint32_t ERR_GET_EXIV2_IMAGE_PROPERTY = BASE_MEDIA_ERR_OFFSET + 306;
const uint32_t ERR_EXIF_META_DATA_IMAGE_IO = BASE_MEDIA_ERR_OFFSET + 307;

const uint32_t ERR_GET_EXIV2_Tag = BASE_MEDIA_ERR_OFFSET + 330;
const uint32_t ERR_VALIDATE_EXIV2_VALUE_FORMAT = BASE_MEDIA_ERR_OFFSET + 331;
const uint32_t ERR_VALIDATE_EXIV2_VALUE_RANGE = BASE_MEDIA_ERR_OFFSET + 332;
const uint32_t ERR_ARRAY_EXIV2_VALUE_FORMAT = BASE_MEDIA_ERR_OFFSET + 333;
const uint32_t ERR_CAST_EXIV2_VALUE = BASE_MEDIA_ERR_OFFSET + 334;
const uint32_t ERR_FORBID_EXIV2_MODIFY = BASE_MEDIA_ERR_OFFSET + 335;
}  // namespace Media
}  // namespace OHOS
