...
const uint32_t ERR_IMAGE_DETAIL_ENHANCER_CREATE_FAIL = BASE_MEDIA_ERR_OFFSET + 85;
const uint32_t ERR_IMAGE_COLOR_SPACE_CONVERTER_CREATE_FAIL = BASE_MEDIA_ERR_OFFSET + 86;
const uint32_t ERR_IMAGE_AI_UNSUPPORTED = BASE_MEDIA_ERR_OFFSET + 87;
const uint32_t ERR_IMAGE_AI_ONLY_SR_SUCCESS = BASE_MEDIA_ERR_OFFSET + 88;
