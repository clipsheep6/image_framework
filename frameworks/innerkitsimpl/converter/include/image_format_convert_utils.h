...
public:
    static bool RGBAF16ToNV21(const uint8_t *srcBuffer, const RGBADataInfo &imageSize, uint8_t **destBuffer,
    ...
    static bool BGRAToNV21(const uint8_t *srcBuffer, const RGBADataInfo &imageSize, uint8_t **destBuffer,
                           size_t &destBufferSize,  [[maybe_unused]]ColorSpace colorSpace);
    static bool RGBAF16ToNV12(const uint8_t *srcBuffer, const RGBADataInfo &imageSize, uint8_t **destBuffer,
                              size_t &destBufferSize, [[maybe_unused]]ColorSpace colorSpace);
