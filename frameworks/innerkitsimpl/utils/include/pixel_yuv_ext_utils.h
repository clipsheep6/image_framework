...
public:
    static bool BGRAToYuv420(const uint8_t *src, uint8_t *dst, int srcW, int srcH, PixelFormat pixelFormat, YUVDataInfo &yuvDataInfo);
    ...
    static bool Yuv420ToARGB(const uint8_t *sample, uint8_t *dst_argb, Size &size,
                             PixelFormat pixelFormat, YUVDataInfo &info);
    static bool YuvRotate(uint8_t* srcPixels, const PixelFormat& format, YUVDataInfo& info,
    ...
    static bool Mirror(uint8_t *src, uint8_t *dst, Size &size, PixelFormat format, YUVDataInfo &info, YUVStrideInfo &dstStrides, bool isReversed);
    static bool FlipXaxis(uint8_t *src, uint8_t *dst, Size &size, PixelFormat format, YUVDataInfo &info,  YUVStrideInfo &dstStrides);
