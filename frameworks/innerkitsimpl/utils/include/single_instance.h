...
#ifndef FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_SINGLE_INSTANCE_H
#define FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_SINGLE_INSTANCE_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_UTILS_INCLUDE_SINGLE_INSTANCE_H
