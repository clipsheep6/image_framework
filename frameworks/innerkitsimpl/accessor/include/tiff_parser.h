...
#ifndef FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_FILE_TIFF_PARSER_H
#define FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_FILE_TIFF_PARSER_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_ACCESSOR_INCLUDE_FILE_TIFF_PARSER_H
