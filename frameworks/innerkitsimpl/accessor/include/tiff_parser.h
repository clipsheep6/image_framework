...
public:
    ...
    static void DecodeDngExif(const unsigned char *dataPtr, const uint32_t &size, ExifData **exifData, unsigned int &maxAddr);
    static void EncodeDngExif(unsigned char **dataPtr, uint32_t &size, ExifData *exifData, unsigned int delta, unsigned int offset);
