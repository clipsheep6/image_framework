...
#ifndef FRAMEWORKS_INNERKITSIMPL_HDR_INCLUDE_HDR_UTILS_H
#define FRAMEWORKS_INNERKITSIMPL_HDR_INCLUDE_HDR_UTILS_H
...
#endif // FRAMEWORKS_INNERKITSIMPL_HDR_INCLUDE_HDR_UTILS_H