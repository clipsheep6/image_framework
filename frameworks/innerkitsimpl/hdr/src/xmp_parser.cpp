...
namespace Media {
using namespace std;
const string XMP_CONTAINER_URI = "http://ns.google.com/photos/1.0/container/";
const string XMP_ITEM_URI = "http://ns.google.com/photos/1.0/container/item/";
const string ADOBE_GAIN_MAP_URI = "http://ns.adobe.com/hdr-gain-map/1.0/";
const string APPLE_HDR_GAIN_MAP_URI = "http://ns.apple.com/HDRGainMap/1.0/";
const string ISO_HDR_GAIN_MAP_URI = "http://www.iso.org/standard/86775/gainmap/1.0/";

const string CONTAINER_DIRECTORY_NAME = "Directory";
const char* PRIMARY_VALUE = "Primary";
const char* GAINMAP_VALUE = "GainMap";

const string ITEM_SEMANTIC_NAME = "Semantic";
const string ITEM_MIME_NAME = "Mime";
const string ITEM_LENGTH = "Length";

const std::string XMLNS_PREFIX = "xmlns:";
const char* XMP_META_ELEMENT_TAG = "x:xmpmeta";
const char* XMP_RDF_ELEMENT_TAG = "rdf:RDF";
const char* XMP_RDF_DESC_ELEMENT_TAG = "rdf:Description";
const char* XMP_RDF_SEQ_ELEMENT_TAG = "rdf:Seq";
const char* XMP_RDF_LI_ELEMENT_TAG = "rdf:li";
const char* XMP_BOOL_FALSE = "False";
const char* XMP_BOOL_TRUE = "True";
const char* XMP_GAIN_MAP_METADATA_VERSION = "1.0";
