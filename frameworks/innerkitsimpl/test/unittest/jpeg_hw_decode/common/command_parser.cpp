...
static struct option g_longOptions[] = {
    ...
    {"out",             required_argument,  nullptr, OPT_OUTPUT},
    {"width",           required_argument,  nullptr, OPT_WIDTH},
    {"height",          required_argument,  nullptr, OPT_HEIGHT},
    {"colorFmt",        required_argument,  nullptr, OPT_COLOR_FMT},
    {"sampleSize",      required_argument,  nullptr, OPT_SAMPLE_SIZE},
...
void CommandOpt::Print() const
{
    ...
    std::cout << "   colorFmt : " << colorFmt << endl;
