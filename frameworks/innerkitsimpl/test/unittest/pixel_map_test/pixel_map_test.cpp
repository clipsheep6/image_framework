...
HWTEST_F(PixelMapTest, PixelMapCreateTest001, TestSize.Level3)
{
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::ARGB_8888 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::ARGB_8888 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::RGB_565 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::RGB_565 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::RGBA_8888 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::RGBA_8888 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::BGRA_8888 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::BGRA_8888 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::RGB_888 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::RGB_888 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::ALPHA_8 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::ALPHA_8 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::RGBA_F16 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::RGBA_F16 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::NV21 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::NV21 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::NV12 To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::NV12 To Others finish\n\n");
    ...
    for (iter = gPixelFormat.begin(); iter != gPixelFormat.end(); ++iter) {
        ...
        std::unique_ptr<PixelMap> pixelMap1 = PixelMap::Create(color, colorlength, offset, width, options);
        EXPECT_NE(pixelMap1, nullptr);
        printf("From PixelFormat::CMYK To %s finish\n\n", iter->second.c_str());
    }
    printf("==== From PixelFormat::CMYK To Others finish\n\n");
