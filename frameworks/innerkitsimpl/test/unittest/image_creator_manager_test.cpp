...
HWTEST_F(ImageCreatorManagerTest, SaveImageCreator001, TestSize.Level3)
{
    ...
    ImageCreatorManager creat;
    shared_ptr<ImageCreator> imageCreator;
    string saveimagecreate = creat.SaveImageCreator(imageCreator);
    ASSERT_EQ(saveimagecreate, "");
...
HWTEST_F(ImageCreatorManagerTest, GetSurfaceByKeyId001, TestSize.Level3)
{
    ...
    ImageCreatorManager creat;
    string keyId = "";
    sptr<Surface> getsurf = creat.GetSurfaceByKeyId(keyId);
...
HWTEST_F(ImageCreatorManagerTest, GetImageCreatorByKeyId001, TestSize.Level3)
{
    ...
    ImageCreatorManager creat;
    string keyId = "";
    shared_ptr<ImageCreator> getimagec = creat.GetImageCreatorByKeyId(keyId);
