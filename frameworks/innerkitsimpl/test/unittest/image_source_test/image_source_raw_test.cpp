...
namespace OHOS {
    namespace Multimedia {
        ...
        static const std::string IMAGE_OUTPUT_DNG_DIR = "/data/test/";
        static const std::string IMAGE_OUTPUT_DNG_PATH = IMAGE_OUTPUT_DNG_DIR+"out-dng.dng";
        static const std::string IMAGE_OUTPUT_JPEG_PATH = IMAGE_OUTPUT_DNG_DIR+"out-jpeg.jpg";
        static const std::string IMAGE_OUTPUT_WEBP_PATH = IMAGE_OUTPUT_DNG_DIR+"out-webp.dng";
        static const std::string IMAGE_OUTPUT_PNG_PATH = IMAGE_OUTPUT_DNG_DIR+"out-png.dng";
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageRGBA8888Codec001, TestSize.Level3)
        {
            /**
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageBGRA8888Codec002, TestSize.Level3)
        {
            /**
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageRGB565Codec003, TestSize.Level3)
        {
            /**
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageARGB8888Codec004, TestSize.Level3)
        {
            /**
             * @tc.steps: step1. create image source by correct file path and format hit.
             * @tc.expected: step1. create image source success.
        ...
        HWTEST_F(ImageSourceRawTest, RawImageBGRA8888Codec005, TestSize.Level3)
        {
            /**
             * @tc.steps: step1. create image source by correct file path and format hit.
             * @tc.expected: step1. create image source success.
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageCodec006, TestSize.Level3)
        {
            /**
            ...
            ASSERT_EQ(imageInfo.size.width, 7280);
            ASSERT_EQ(imageInfo.size.height, 5456);
        }
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageBufferCodec008, TestSize.Level3)
        {
            /**
            ...
            int64_t packSize = OHOS::ImageSourceUtil::PackDNGImage(IMAGE_OUTPUT_DNG_FILE_PATH, pixelMap);
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageStreamCodec009, TestSize.Level3)
        {
            /**
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageMultipleCodec10, TestSize.Level3)
        {
            /**
             ...
             */
            int64_t packSize = OHOS::ImageSourceUtil::PackDNGImage(IMAGE_OUTPUT_DNG_FILE_PATH, pixelMap1);
            ASSERT_NE(packSize, 0);
            packSize = OHOS::ImageSourceUtil::PackDNGImage(IMAGE_OUTPUT_DNG_FILE_PATH, pixelMap2);
            ASSERT_NE(packSize, 0);
        }
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageDecode015, TestSize.Level3)
        {
            /**
             * @tc.steps: step1. create image source by correct file path and format hit.
             * @tc.expected: step1. create image source success.
         ...
         * @tc.type: FUNC
         */
        HWTEST_F(ImageSourceRawTest, RawImageDecode016, TestSize.Level3)
        {
            /**
             * @tc.steps: step1. create image source by correct file path and format hit.
             * @tc.expected: step1. create image source success.
