...
/**
 * @tc.name: PngGetEncodedFormat002
 * @tc.desc: Decoding non-nine-patch picture
 * @tc.type: FUNC
 */
HWTEST_F(ImageSourcePngTest, PngGetEncodedFormat002, TestSize.Level3)
{
    /**
     * @tc.steps: step1. create png image source by istream source stream and default format hit
     * @tc.expected: step1. create png image source success.
    ...
    GTEST_LOG_(INFO) << "ImageSourcePngTest: PngGetEncodedFormat002 imageinfo1: " << imageinfo1.encodedFormat;
    /**
     * @tc.steps: step3. decode image source to pixel map by default decode options.
     * @tc.expected: step3. decode image source to pixel map success.
     */
    ...
    GTEST_LOG_(INFO) << "ImageSourcePngTest: PngGetEncodedFormat002 imageinfo2:" << imageinfo2.encodedFormat;
}
} // namespace Multimedia
} // namespace OHOS