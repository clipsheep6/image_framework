...
{
    IMAGE_ERR(" yzp SendablePixelMapNapi Init in");
...
{
    IMAGE_ERR("NewPixelNapiInstance IN");
    napi_status status;
    if (pixelMap == nullptr) {
...
{
    IMAGE_ERR("CreateSendablePixelMapComplete IN");
...
{
    IMAGE_ERR("CreateSendablePixelMap IN");
...
{
    IMAGE_ERR("yzp ConvertFromPixelMap IN");
    if (SendablePixelMapNapi::GetConstructor() == nullptr) {
        napi_value exports = nullptr;
        napi_create_object(env, &exports);
        SendablePixelMapNapi::Init(env, exports);
...
{
    IMAGE_ERR("yzp CreateSendablePixelMapSync IN");
    if (SendablePixelMapNapi::GetConstructor() == nullptr) {
        napi_value exports = nullptr;
        napi_create_object(env, &exports);
        SendablePixelMapNapi::Init(env, exports);
    ...
    status = napi_get_reference_value(env, sConstructor_, &constructor);
    if (IMG_IS_OK(status)) {
            IMAGE_ERR("yzp CreateSendablePixelMapSync  2 pixelmap:%{public}d", asyncContext->rPixelMap->GetWidth());
