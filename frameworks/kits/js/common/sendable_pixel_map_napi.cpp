...
napi_value SendablePixelMapNapi::Init(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor static_prop[] = {
        DECLARE_NAPI_STATIC_FUNCTION("createSendablePixelMap", CreateSendablePixelMap),
        DECLARE_NAPI_STATIC_FUNCTION("createPremultipliedSendablePixelMap", CreatePremultipliedSendablePixelMap),
        DECLARE_NAPI_STATIC_FUNCTION("createUnpremultipliedSendablePixelMap", CreateUnpremultipliedSendablePixelMap),
        DECLARE_NAPI_STATIC_FUNCTION("createSendablePixelMapSync", CreateSendablePixelMapSync),
        DECLARE_NAPI_STATIC_FUNCTION("unmarshalling", Unmarshalling),
        DECLARE_NAPI_STATIC_FUNCTION("createSendablPixelMapFromParcel", CreateSendablPixelMapFromParcel),
#if !defined(IOS_PLATFORM) && !defined(A_PLATFORM)
        DECLARE_NAPI_STATIC_FUNCTION("createSendablePixelMapFromSurface", CreateSendablePixelMapFromSurface),
...
static napi_status status NapiUnwrap(napi_env env, napi_value object, void** result, bool isSendable = true)
{
...
extern "C" __attribute__((visibility("default"))) void* OHOS_MEDIA_GetPixelMap(napi_env env, napi_value value)
{
    ...
    NapiUnwrap(env, value, reinterpret_cast<void**>(&pixmapNapi));
    IMG_NAPI_CHECK_RET_D(IMG_NOT_NULL(pixmapNapi), nullptr,
...
napi_value SendablePixelMapNapi::ConvertFromPixelMap(napi_env env, napi_callback_info info)
{
    ...
    std::unique_ptr<SendablePixelMapNapi> pixelMapNapi = nullptr;
    NapiUnwrap(env, thisVar, reinterpret_cast<void**>(&pixelMapNapi), false);
...
napi_value SendablePixelMapNapi::Unmarshalling(napi_env env, napi_callback_info info)
{
    ...
    NapiUnwrap(env, argValue[NUM_0], (void **)&napi_messageSequence, false);
...
#else
{
    ...
    std::unique_ptr<PixelMapAsyncContext> asyncContext = std::make_unique<PixelMapAsyncContext>();
    NapiUnwrap(env, argValue[NUM_0], (void **)&napi_messageSequence, false);
    IMG_NAPI_CHECK_RET_D(IMG_NOT_NULL(napi_messageSequence), result,
