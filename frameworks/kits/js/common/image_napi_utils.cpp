...
bool ImageNapiUtils::IsProcessRunning(const char* processName) {
    return __progname != nullptr && processName != nullptr
        && strncmp(__progname, processName, strlen(processName)) == 0;
}
}  // namespace Media
}  // namespace OHOS
