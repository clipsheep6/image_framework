...
#ifndef HWE_ENC_IMAGE_CL_H
#define HWE_ENC_IMAGE_CL_H
#include <atomic>
#include <mutex>
#include <set>
#include <stdio.h>
...
#define DIM (4)
#define MAX_WIDTH_HEIGHT (100000)

#define PATITION_MODE_NUMS (73)
#define BIT_MAP_NUM (2)
#define TIMEUS_UNIT (1000)

namespace OHOS {
namespace Media {
extern const char *g_programSource;
