...
static void ExifIntValueByFormat(unsigned char *b, ExifByteOrder order, ExifFormat format, long value)
{
    switch (format) {
        case EXIF_FORMAT_SHORT:
            exif_set_short(b, order, static_cast<ExifShort>(value));
            break;
        case EXIF_FORMAT_SSHORT:
            exif_set_sshort(b, order, static_cast<ExifSShort>(value));
            break;
        case EXIF_FORMAT_LONG:
            exif_set_long(b, order, static_cast<ExifLong>(value));
            break;
        case EXIF_FORMAT_SLONG:
            exif_set_slong(b, order, static_cast<ExifSLong>(value));
            break;
